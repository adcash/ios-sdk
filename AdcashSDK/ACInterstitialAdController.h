...
@protocol ACInterstitialAdControllerDelegate;

/**
 * The `ACInterstitialAdController` class provides a full-screen advertisement that can be
 * displayed during natural transition points in your application.
 */

@interface ACInterstitialAdController : UIViewController
 ...
 *
 * @param adUnitId A string representing a Adcash ad unit ID.
 */
...
/**
 * The delegate (`ACInterstitialAdControllerDelegate`) of the interstitial ad object.
 */
@property (nonatomic, assign) id<ACInterstitialAdControllerDelegate> delegate;

/** @name Setting Request Parameters */

/**
 * The Adcash ad unit ID for this interstitial ad.
 *
 * Ad unit IDs are created on the Adcash website. An ad unit is a defined placement in your
 ...
 * `ACInterstitialAdControllerDelegate` if you would like to be notified as loading succeeds or
 * fails.
 */
- (void)loadAd;
 ...
 * third-party ad networks. See `ACInterstitialAdControllerDelegate` for more details.
 */
 ...
 *
 * `ACInterstitialAdControllerDelegate` provides optional methods that you may implement to stay
...
/**
 * Notifies Adcash that a custom event has successfully loaded an interstitial.
 *
 * @bug **Warning**: This method has been deprecated. You should instead implement interstitial
 * custom events using a subclass of `ACInterstitialCustomEvent`.
 */
- (void)customEventDidLoadAd __attribute__((deprecated));

/**
 * Notifies Adcash that a custom event has failed to load an interstitial.
 *
 * @bug **Warning**: This method has been deprecated. You should instead implement interstitial
 * custom events using a subclass of `ACInterstitialCustomEvent`.
 */
...
/**
 * Notifies Adcash that a user has tapped on a custom event interstitial.
 *
 * @bug **Warning**: This method has been deprecated. You should instead implement interstitial
 * custom events using a subclass of `ACInterstitialCustomEvent`.
 */
...
/**
 * The delegate of an `ACInterstitialAdController` object must adopt the
 * `ACInterstitialAdControllerDelegate` protocol.
 *
...
@protocol ACInterstitialAdControllerDelegate <NSObject>
 ...
 */
- (void)interstitialDidLoadAd:(ACInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidFailToLoadAd:(ACInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialWillAppear:(ACInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidAppear:(ACInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialWillDisappear:(ACInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidDisappear:(ACInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidExpire:(ACInterstitialAdController *)interstitial;
 ...
 */
- (void)dismissInterstitial:(ACInterstitialAdController *)interstitial __attribute__((deprecated));
