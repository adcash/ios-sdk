//
//  ACInterstitialCustomEventDelegate.h
//  Adcash
//
...
/**
 * Instances of your custom subclass of `ACInterstitialCustomEvent` will have an `ACInterstitialCustomEventDelegate` delegate.
 * You use this delegate to communicate events ad events back to the Adcash SDK.
 *
 ...
 * network's events and the callbacks defined on `ACInterstitialCustomEventDelegate`.
 */

@protocol ACInterstitialCustomEventDelegate <NSObject>

/**
 * The user's current location.
 *
 * @return This method provides the location that was passed into the parent `ACInterstitialAdController`.  The Adcash
 * SDK does **not** automatically request the user's location.  It is your responsibility to pass the location
 * into `ACInterstitialAdController`.
 *
 ...
 *
 * @param customEvent You should pass `self` to allow the Adcash SDK to associate this event with the correct
 * instance of your custom event.
 *
 * @param ad (*optional*) An object that represents the ad that was retrieved.  The Adcash SDK does not
 ...
 * presented) *after* they have loaded.  You may use this method to inform the Adcash SDK that a
 ...
 *
 * @warning **Important**: You should **only** call this method if you have [opted out of automatic click and impression tracking]([ACInterstitialCustomEvent enableAutomaticImpressionAndClickTracking]).
 * By default the Adcash SDK automatically tracks impressions.
 *
 ...
 *
 * @warning **Important**: You should **only** call this method if you have [opted out of automatic click and impression tracking]([ACInterstitialCustomEvent enableAutomaticImpressionAndClickTracking]).
 * By default the Adcash SDK automatically tracks clicks.
 *
