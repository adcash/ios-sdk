...
/**
 * The ACTableViewAdManager class provides convenient functionality for adding advertisements
...
@interface ACTableViewAdManager : NSObject
 ...
 * should implement the ACNativeAdRendering protocol.
