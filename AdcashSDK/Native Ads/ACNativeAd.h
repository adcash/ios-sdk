...
@protocol ACNativeAdAdapter;
@class ACAdConfiguration;

/**
 * The ACNativeAd class is used to render and manage events for a native advertisement. The
 ...
 *
 * The provided view should implement the ACNativeAdRendering protocol to correctly display the ad content.
 *
