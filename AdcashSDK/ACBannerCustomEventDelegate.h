...
/**
 * Instances of your custom subclass of `ACBannerCustomEvent` will have an `ACBannerCustomEventDelegate` delegate.
 ...
 * network's events and the callbacks defined on `ACBannerCustomEventDelegate`.
 */

@protocol ACBannerCustomEventDelegate <NSObject>

/**
 * The view controller instance to use when presenting modals.
 *
 * @return `viewControllerForPresentingModalView` returns theAC same view controller that you
 * specify when implementing the `ACAdViewDelegate` protocol.
 */
 ...
 *
 * @return This method provides the location that was passed into the parent `ACAdView`.  The Adcash
 ...
 *
 * @param ad The `UIView` representing the banner ad.  This view will be inserted into the `ACAdView`
 * and presented to the user by the Adcash SDK.
 *
 ...
 *
 * @warning **Important**: You should **only** call this method if you have [opted out of automatic click and impression tracking]([ACBannerCustomEvent enableAutomaticImpressionAndClickTracking]).
