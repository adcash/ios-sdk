//
//  ACMRAIDInterstitialViewController.m
//  Adcash
//
...
@interface ACMRAIDInterstitialViewController ()
...
@implementation ACMRAIDInterstitialViewController
...
- (id)initWithAdConfiguration:(ACAdConfiguration *)configuration
{
    ...
    if (self) {
        ...
        self.interstitialView = [[ACInstanceProvider sharedProvider] buildMRAdViewWithFrame:frame
                                                                            allowsExpansion:NO
