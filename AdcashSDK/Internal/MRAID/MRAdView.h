...
@class MRAdViewDisplayController, MRProperty, ACAdConfiguration;
...
@interface MRAdView : UIView <UIWebViewDelegate, ACAdDestinationDisplayAgentDelegate, MRCalendarManagerDelegate, MRPictureManagerDelegate, MRVideoPlayerManagerDelegate> {
