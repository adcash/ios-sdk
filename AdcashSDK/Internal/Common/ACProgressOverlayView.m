...
@interface ACProgressOverlayView ()
...
@implementation ACProgressOverlayView
...
{
    self = [self initWithFrame:ACKeyWindow().bounds];
    if (self) {
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *image = [UIImage imageNamed:@"ACCloseButtonX.png"];
