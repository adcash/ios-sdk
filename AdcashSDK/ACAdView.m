...
@interface ACAdView () <ACBannerAdManagerDelegate>

@property (nonatomic, retain) ACBannerAdManager *adManager;
@property (nonatomic, assign) UIView *adContentView;
@property (nonatomic, assign) CGSize originalSize;
@property (nonatomic, assign) ACNativeAdOrientation allowedNativeAdOrientation;
...
- (id)initWithAdUnitId:(NSString *)adUnitId size:(CGSize)size
{
    ...
    if (self = [super initWithFrame:f])
    {
        ...
        self.allowedNativeAdOrientation = ACNativeAdOrientationAny;
        self.adUnitId = (adUnitId) ? adUnitId : DEFAULT_PUB_ID;
        self.adManager = [[ACInstanceProvider sharedProvider] buildACBannerAdManagerWithDelegate:self];
    }
    return self;
}
...
#pragma mark - <ACBannerAdManagerDelegate>
